...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full items-center justify-center rounded-none bg-muted text-sm text-foreground group-data-[size=sm]/avatar:text-xs",
        className
      )}
      {...props}
    />
...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-8 shrink-0 items-center justify-center rounded-none bg-muted text-xs text-foreground ring-2 ring-background group-has-data-[size=lg]/avatar-group:size-10 group-has-data-[size=sm]/avatar-group:size-6 [&>svg]:size-4 group-has-data-[size=lg]/avatar-group:[&>svg]:size-5 group-has-data-[size=sm]/avatar-group:[&>svg]:size-3",
        className
      )}
      {...props}
    />
