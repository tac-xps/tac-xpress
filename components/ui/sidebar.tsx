...
function Sidebar({
  ...
  return (
    <div
      className="group peer sticky top-0 hidden h-svh shrink-0 text-sidebar-foreground md:block"
      data-state={state}
    ...
    >
      ...
      <div
        ...
        className={cn(
          "hidden w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear",
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-none px-2 text-xs font-medium tracking-wide text-muted-foreground ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        className
      )}
      {...props}
    />
