      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mx-auto mt-7 flex max-w-100 items-center justify-center gap-3">
          ...
          {showProgress && autoplayDelay > 0 && (
            <div
              className={`relative h-2 w-full justify-center overflow-hidden rounded-none border-2 border-border bg-background transition-opacity duration-300 ease-in-out ${
      ...
      >
        {thumbnails?.map((thumb, index) => (
          <button
            ...
            className={`flex-shrink-0 overflow-hidden rounded-none border-2 object-cover transition-all duration-200 ${
